...
#ifndef WaveOnPositionContent_h
#define WaveOnPositionContent_h
...
static string shaderOnPosition_uniformsHeader =
STRINGIFY(
...
static string shaderOnPosition_uniforms =
STRINGIFY(
...
static string shaderOnPosition_functions =
STRINGIFY(
          // functions
...
static string shaderOnPosition_mainHeader =
STRINGIFY(
          void main(){
              ...
              static string shaderOnPosition_objectGradient =
              STRINGIFY(
              ...
              static string shaderOnPosition_output =
              STRINGIFY(
              ...
              class WaveOnPositionContent : public WaveContent{
              public:
                  ofFbo fboShader;
                  ofMesh mesh;
                  ...
                  void createShader(){
                      ...
                      shaderScript << shaderOnPosition_uniformsHeader << endl;
                      for(int i = 1; i <= externalObjects->size(); i++){
                          shaderScript << replaceAll(shaderOnPosition_uniforms, "$0", ofToString(i)) << endl;
                      }
                      shaderScript << shaderOnPosition_functions << endl;
                      shaderScript << shaderOnPosition_mainHeader << endl;
                      for(int i = 1; i <= externalObjects->size(); i++){
                          shaderScript << replaceAll(shaderOnPosition_objectGradient, "$0", ofToString(i)) << endl;
                      }
                      shaderScript << shaderOnPosition_output << endl;
