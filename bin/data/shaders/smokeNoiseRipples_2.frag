...
// Create pulses
   ...
   float maxSize = 1.;
   float rings = ring(stDot, mod(time*0.9, maxSize), 0.5, 0.02);
   rings += ring(stDot, mod(time*1.3+2., 2.), 0.1, 0.02);
   rings += ring(stDot, mod(time*2.2+2., 2.), 0.15, 0.02);
   rings += ring(stDot, mod(time*4.2+4., 2.), 0.2, 0.02);
